        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <article className="prose prose-lg prose-invert max-w-none">
            <div className="text-gray-300 leading-relaxed space-y-8 text-lg" style={{ fontFamily: 'var(--font-dm-sans), sans-serif' }}>
              ...
              <h2 className="text-3xl font-bold text-white mt-10 mb-6">Step-by-Step Learning Path for Beginners</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                ...
                <div className="bg-gray-900/60 border border-gray-700 rounded-lg p-6">
                  <h4 className="text-lg font-semibold text-purple-300 mb-3">Development Environment</h4>
                  <ul className="text-sm text-gray-300 space-y-1">
              ...
              <div className="space-y-4 my-8">
                <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-6">
                  <h4 className="text-lg font-semibold text-red-300 mb-3">Project 1: Simple Prediction Market</h4>
                  <p className="text-gray-300">
                ...
                <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-6">
                  <h4 className="text-lg font-semibold text-orange-300 mb-3">Project 2: AI-Generated NFT Collection</h4>
                  <p className="text-gray-300">
                ...
                <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-6">
                  <h4 className="text-lg font-semibold text-yellow-300 mb-3">Project 3: Smart Contract Auditor</h4>
                  <p className="text-gray-300">
                    Build a system that uses AI to analyze smart contracts for vulnerabilities 
