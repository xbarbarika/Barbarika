        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <article className="prose prose-lg prose-invert max-w-none">
            <div className="text-gray-300 leading-relaxed space-y-6" style={{ fontFamily: 'var(--font-dm-sans), sans-serif' }}>
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">The Value Proposition</h2>
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">🏢 Business Benefits</h2>
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">🌍 Societal Benefits</h2>
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">📈 Industry-Specific Benefits</h2>
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">🎯 Measurable Impact</h2>
